...
// Define props interface for RadiusLow component
interface RadiusLowProps {
  onChange: (low: number) => void; // Function to handle change in low radius value
  radiusLowProp: number; // Current low radius value passed as prop
}

// Functional component for handling low radius input
const RadiusLow: React.FC<RadiusLowProps> = ({ onChange }) => {
  const [lowInputValue, setLowInputValue] = useState<string>(''); // State to manage low radius input value
  ...
  return (
    <div className='constraint'>
      <Box
        ...
        autoComplete="off"
      >
        {/* Text field for entering low radius value */}
        <TextField
...
export default RadiusLow; // Exporting RadiusLow component
